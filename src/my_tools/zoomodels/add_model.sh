...
MODEL_DIR=/hdd/src/neuralmagic/zoomodels/src/dvc/nlp-text_classification/bert-large/pytorch-huggingface/qqp/base-none/
MODEL_DIR=/hdd/src/neuralmagic/zoomodels/src/dvc/nlp-text_classification/bert-large/pytorch-huggingface/qqp/24layer_pruned80_quant-none-vnni/
MODEL_DIR=/hdd/src/neuralmagic/zoomodels/src/dvc/nlp-question_answering/bert-large/pytorch-huggingface/squad/base-none
MODEL_DIR=/hdd/src/neuralmagic/zoomodels/src/dvc/nlp-question_answering/bert-large/pytorch-huggingface/squad/24layer_pruned80_quant-none-vnni
MODEL_DIR=/hdd/src/neuralmagic/zoomodels/src/dvc/nlp-text_classification/bert-large/pytorch-huggingface/mnli/24layer_pruned80_quant-none-vnni
MODEL_DIR=/hdd/src/neuralmagic/zoomodels/src/dvc/nlp-text_classification/bert-large/pytorch-huggingface/mnli/base-none
...
MODEL_DIR=/hdd/src/neuralmagic/zoomodels/src/dvc/nlp-text_classification/obert-base/pytorch-huggingface/qqp/12layer_pruned80-none-vnni
...
MODEL_DIR=/hdd/src/neuralmagic/zoomodels/src/dvc/nlp-text_classification/obert-base/pytorch-huggingface/mnli/12layer_pruned80-none-vnni
MODEL_DIR=/hdd/src/neuralmagic/zoomodels/src/dvc/nlp-token_classification/bert-large/pytorch-huggingface/conll2003/base-none
MODEL_DIR=/hdd/src/neuralmagic/zoomodels/src/dvc/nlp-token_classification/bert-large/pytorch-huggingface/conll2003/pruned80_quant-none-vnni
...
MODEL_DIR=/hdd/src/neuralmagic/zoomodels/src/dvc/nlp-text_classification/bert-base/pytorch-huggingface/mnli/12layer_pruned90-none
...
# Used for downstream
cd ${ZOOMODELS_DIR}; python ${ZOOMODELS_DIR}/scripts/model_management.py dvc-add --model-paths ${MODEL_DIR}

# # Ignore recipes
# cd ${ZOOMODELS_DIR}; python ${ZOOMODELS_DIR}/scripts/model_management.py dvc-add --model-paths ${MODEL_DIR} --validate-recipes 0 
